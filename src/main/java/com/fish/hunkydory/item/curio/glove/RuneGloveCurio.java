...
public class RuneGloveCurio extends HunkydoryCurio {
    ...
    public void addAttributeModifiers(Multimap<Holder<Attribute>, AttributeModifier> map, SlotContext slotContext, ItemStack stack) {
        map.put(ModAttributes.RUNE_GLOVE, new AttributeModifier(HAS_RUNE_GLOVE, 1, AttributeModifier.Operation.ADD_VALUE));
        CuriosApi.addSlotModifier(map, "rune", RUNE_GLOVE_RUNES, 4, AttributeModifier.Operation.ADD_VALUE);
    }
}
